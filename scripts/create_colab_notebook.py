    ...
    "cells": [
        {
            ...
            "source": [
                ...
                "2. Add `NGROK_AUTHTOKEN` in the Colab Secrets panel, then fill in the configuration form below.\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "    raise ValueError(\"Add NGROK_AUTHTOKEN in the Colab Secrets panel before running.\")"
            ]
        },
        {
            "cell_type": "markdown",
        ...
        },
        {
            ...
            "source": [
                ...
                "    [\"python3\", \"-m\", \"uvicorn\", \"src.api.app:app\", \"--host\", \"0.0.0.0\", \"--port\", str(PORT), \"--workers\", \"1\"],\n",
                "    stdout=subprocess.PIPE,\n",
                "    stderr=subprocess.STDOUT,\n",
                "    text=True\n",
                ")\n",
                "\n",
                "# Wait until startup warmup finishes and the API reports ready.\n",
                "health_url = f\"http://127.0.0.1:{PORT}/health\"\n",
                "deadline = time.time() + 900\n",
                "while time.time() < deadline:\n",
                "    if api_process.poll() is not None:\n",
                "        raise RuntimeError(f\"FastAPI exited during startup with code {api_process.returncode}\")\n",
                "    try:\n",
                "        with urllib.request.urlopen(health_url, timeout=3) as response:\n",
                "            health = json.loads(response.read().decode())\n",
                "        if health.get(\"ready\") is True:\n",
                "            print(f\"API ready with active role: {health.get('active_role')}\")\n",
                "            break\n",
                "        print(f\"API not ready yet: {health}\")\n",
                "    except Exception:\n",
                "        pass\n",
                "    time.sleep(5)\n",
                "else:\n",
                "    api_process.terminate()\n",
                "    raise TimeoutError(\"FastAPI did not become ready within 15 minutes.\")\n",
                "\n",
