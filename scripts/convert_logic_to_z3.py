...
def fol_to_z3_code(premises_fol: str, conclusion_fol: str,
    ...
    lines.append('# Negate-and-check-unsat decision procedure')
    lines.append('s.push()')
    lines.append('s.add(Not(conclusion))')
    lines.append('r1 = s.check()  # unsat -> conclusion is entailed')
    lines.append('s.pop()')
    lines.append('')
    lines.append('s.push()')
    lines.append('s.add(conclusion)')
    lines.append('r2 = s.check()  # unsat -> conclusion is contradicted')
    lines.append('s.pop()')
    lines.append('')
    lines.append('if r1 == unsat:')
    lines.append('    print("Predicted: True")')
    lines.append('elif r2 == unsat:')
    lines.append('    print("Predicted: False")')
    lines.append('else:')
    lines.append('    print("Predicted: Unknown")')
