...
_Lưu ý:_ `premises-NL` là optional. Bài Type 2 (Physics) thường sẽ không có field này hoặc là mảng rỗng. Classifier node trong LangGraph sẽ tự động route dựa trên việc có `premises` hay không.
