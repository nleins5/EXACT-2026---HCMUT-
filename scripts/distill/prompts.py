"""Teacher prompts for knowledge distillation.

Two modes:
- EXTRACT (default): BTC dataset already has `cot` field with reasoning + formulas.
  Teacher only needs to EXTRACT formula list, symbol map, clean SymPy code.
  Output is shorter, deterministic, saves tokens.
- GENERATE: Used for problems without CoT, teacher reasons from scratch.

Output must be JSON matching KBRecord schema, no markdown fences, no prose outside JSON.
"""
from __future__ import annotations

# ────────────────────────────────────────────────────────────────────────
# EXTRACT MODE - preferred, used when dataset has CoT
# ────────────────────────────────────────────────────────────────────────
...
# ────────────────────────────────────────────────────────────────────────
# GENERATE MODE - fallback, keep for problems without CoT
# ────────────────────────────────────────────────────────────────────────
